        ...
        <div className='md:px-5'>
            <Link to={`/products/${product.id}`}>
                ...
                >
                    ...
                    <h3 className='text-sm font-semibold  text-white px-1 bg-red-400 rounded-xl w-10 md:w-13 text-center relative bottom-68 md:bottom-118 left- md:left-2 ml-3 md:ml-0'>NEW</h3>
                    ...
                    >
                        <button className="bg-white p-2 rounded-full cursor-pointer shadow-md hover:bg-yellow-500 transition relative -left-4 md:left-35 bottom-25 md:bottom-50">
                            <FaEye size={12} className="text-gray-800 hover:text-white " />
                        </button>
                        <button className="bg-white p-2 rounded-full cursor-pointer shadow-md hover:bg-yellow-500 transition relative -left-5 md:left-33 bottom-25  md:bottom-50">
